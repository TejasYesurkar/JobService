...
Public Class jobLaserReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIBI.jobLaserReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedjobLaserReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As jobLaserReport = New jobLaserReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
