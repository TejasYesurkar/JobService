...
Public Class JobservicesList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIBI.JobservicesList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_HeadingText() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedJobservicesList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JobservicesList = New JobservicesList()
        rpt.Site = Me.Site
        Return rpt
    End Function
